...
This directory keeps the non-code project material out of the repository root.

## Core Docs
- [ARCHITECTURE.md](./ARCHITECTURE.md): runtime boundaries, data flow, and module responsibilities
...
## Assets
- [assets/delightful-dogs.png](./assets/delightful-dogs.png): repository banner image
